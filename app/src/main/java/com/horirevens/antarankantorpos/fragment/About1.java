...
public class About1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.content_about1, container, false);
        ivEmail = (ImageView) rootView.findViewById(R.id.iv_email1);
        ivPhone = (ImageView) rootView.findViewById(R.id.iv_phone1);
        ...
        return rootView;
        //return inflater.inflate(R.layout.content_about1, container, false);
    }
}
